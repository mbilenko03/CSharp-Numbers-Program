...
namespace Fibinachi_Sequence
{
  class FibinachiSequence
  {
    ...
    static int[] listFibi(int useTerm)
    {
    ...
    static void printFibi(int[] arrFibi)
    {
    ...
    static void sumFibi(int[] arrFibi)
    {
    ...
    static void phiFibi(int useTerm, int[] arrFibi)
    {
